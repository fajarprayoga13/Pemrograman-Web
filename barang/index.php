        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2> SELAMAT DATANG BAGI PEKERJA</h2>
                    <br>
                    <h4>Ada peraturan yang harus di perhatikan:</h4><br>
                    <p>1. Masuk tepat waktu
                    </p>
                    <p>2. Jangan lupa lakukan 5S</p>
                    <p>3. Usahakan bekerja dengan giat</p>
                </div>
                <!-- /.container-fluid -->
            </div>
            <!-- End of Main Content -->
